...
-- Keep existing insert policy (assumed to exist). We purposely do NOT create an UPDATE policy; updates will be done via trigger.
...
CREATE POLICY IF NOT EXISTS "Allow anon insert user_log"
ON public.user_log
FOR INSERT
TO anon
WITH CHECK (true);
